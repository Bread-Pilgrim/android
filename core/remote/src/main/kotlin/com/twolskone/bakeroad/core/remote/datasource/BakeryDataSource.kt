...
interface BakeryDataSource {
    ...
    suspend fun getPreferenceBakeries(areaCodes: String, pageNo: Int, pageSize: Int): BakeriesResponse
    suspend fun getHotBakeries(areaCodes: String, pageNo: Int, pageSize: Int): BakeriesResponse
    ...
    suspend fun getMyReviews(bakeryId: Int, pageNo: Int, pageSize: Int): BakeryReviewsResponse
